...
namespace _15_Collections
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Foreach ve List.ForeEch ile elemanlara erişim
            ...
            foreach (var kullanıcı in kullanıcıListesi)
            {
                ...
                Console.WriteLine("yaş: "+ kullanıcı.Yas);
            }
    ...
    public class Kullanıcılar{
        ...
        public string Soyisim {get=> soyİsim; set=> soyİsim = value;}
